<?php
      $reqcount=$bdd->query("SELECT * FROM produits WHERE type='Jeux vidéo'");
...
<?php
    ...
    echo "<div id='pagination'>";
       if($pg>1)
       {
       echo "<a href='index.php?action=jeux&page=".($pg-1)."' title='Page précédente'><</a>&nbsp;";
       }
       echo "Page ".$pg;
       if($pg!=$nbpage)
       {
       echo " <a href='index.php?action=jeux&page=".($pg+1)."' title='Page suivante'>></a>";
       }            
    echo "</div>";
?>
<div class="container">
